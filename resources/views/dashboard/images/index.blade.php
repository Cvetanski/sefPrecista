...
@section('content')
    ...
    <div class="row">
        <div class="col-12 pb-5">
            <a href="{{ route('images.create') }}" class="btn btn-success float-left">@lang('Додади Нова Слика')</a>
        </div>
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Сите Слики</h3>
                </div>
                <div class="card-body">
