...
@section('content')
    ...
    <div class="row">
        <div class="col-12 pb-5">
            <a href="{{ route('categories.create') }}" class="btn btn-success float-left">@lang('Додади Нова Категорија')</a>
        </div>
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Сите Категории</h3>
                </div>
                <div class="card-body">
        ...
        $(function() {
            $('.toggle-class').change(function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{route ('publish-unpublish-category') }}',
                    data: {'published': published, 'category_id': category_id},
